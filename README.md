Welcome to my Java project! This repository contains the code and resources for a Java application I've been working on. The project aims to taking order from the user in an effective way.
